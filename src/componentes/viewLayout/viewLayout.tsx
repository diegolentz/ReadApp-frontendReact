    ...
    return <>
        ...
        <main>
            ...
            <ul className="nav-menu">
                ...
                <NavLink
                    to={`${viewPaths.home.dashboard.path}`}
                    className={({ isActive }) =>
                ...
                <NavLink
                    to={`${viewPaths.home.books.path}`}
                    className={({ isActive }) =>
                        isActive ? "active" : "pending"
                    }
                >
                    <li className="nav-menu__option" onClick={
                        () => handleOptionSelect(viewPaths.home.books.cleanName)
                    }

                    ><img src="/src/assets/book.svg" alt="FOTO" /></li>
